...
// Code for the functions.php file in theme

/**
 * Sell only in specific states using woocommerce
 * Change Country Code and States below
 * Remove the states from list that you want to hide from shop checkout 
 * Or only use states that are allowed
 */

// for United States

add_filter( 'woocommerce_states', 'wsp_allowed_states' );
function wsp_allowed_states( $states ) {
  $states['US'] = array(
